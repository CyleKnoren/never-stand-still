...
const gear = [
  {
    ...
    rating: 5,
    desc: "The best trail running shoe on the market. Grippy, lightweight and comfortable on long days out.",
  },
  {
    id: 2,
    ...
    rating: 5,
    desc: "The ultimate multi day pack. Comfortable, well ventilated and bombproof.",
  },
  {
    id: 3,
    name: "Garmin Fenix 7",
    ...
    subcategory: "Watches",
    rating: 5,
    desc: "The ultimate adventure watch. GPS, heart rate, topographic maps and a battery that lasts weeks.",
  },
  {
    id: 4,
    ...
    subcategory: "Jackets",
    rating: 4,
    desc: "Packs into its own pocket. Windproof and perfect for unpredictable mountain weather.",
  },
  {
    id: 5,
    ...
    rating: 4,
    desc: "A reliable headlamp for early morning starts and late finishes on the trail.",
  },
  {
    id: 6,
    ...
    subcategory: "Cooking",
    rating: 5,
    desc: "Ultralight, compact and boils water fast. The go-to stove for any backpacking trip.",
  },
]
