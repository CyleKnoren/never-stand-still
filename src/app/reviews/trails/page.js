...
const trails = [
  { id: 1, name: "Jonkershoek Hidden Single-Track", region: "Stellenbosch", type: "MTB", difficulty: "Hard", duration: "Day Hike", onTrail: true, desc: "Fast flowing singletrack through the Jonkershoek Nature Reserve." },
  { id: 2, name: "Skeleton Gorge", region: "Cape Town", type: "Hiking", difficulty: "Moderate", duration: "Day Hike", onTrail: true, desc: "A stunning hike through Kirstenbosch up into the Hottentots Holland mountains." },
  { id: 3, name: "Trad on the Cederberg Wall", region: "Cederberg", type: "Climbing", difficulty: "Hard", duration: "Multi Day", onTrail: false, desc: "Three days, one big route, and a hard lesson about humility on one of SA's most spectacular cliffs." },
  { id: 4, name: "Otter Trail", region: "Garden Route", type: "Hiking", difficulty: "Hard", duration: "Multi Day", onTrail: true, desc: "South Africa's most famous trail — 5 days along the Wild Coast." },
]
...
function TrailsContent() {
  ...
  useEffect(() => {
    ...
    if (filter) {
      const match = types.find(t => t.toLowerCase() === filter.toLowerCase())
